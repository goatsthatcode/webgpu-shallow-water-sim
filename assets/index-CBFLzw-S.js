...
`,ge=8;function Je(e,a,s,u,o){const n=e.createComputePipeline({label:"lf",layout:"auto",compute:{module:e.createShaderModule({label:"lf-compute",code:Ze}),entryPoint:"cs_main"}}),d=n.getBindGroupLayout(0),g=[e.createBindGroup({label:"lf A→B",layout:d,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:a[0]}},{binding:2,resource:{buffer:a[1]}}]}),e.createBindGroup({label:"lf B→A",layout:d,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:a[1]}},{binding:2,resource:{buffer:a[0]}}]})];let c=0;return{tick(f,t){const l=f.beginComputePass({label:"lf"});l.setPipeline(n);for(let h=0;h<t;h++)l.setBindGroup(0,g[c]),l.dispatchWorkgroups(u/ge,o/ge),c=1-c;l.end()},get readBuf(){return c},setCur(f){c=f},destroy(){}}}const en=`// Two-layer SWE right-hand side: centered differences, no spatial averaging.
...
`,me=8,tn=256;function rn(e,a,s,u,o){const n=u*o*6*4,d=u*o*6,g=Math.ceil(d/tn),c=e.createBuffer({label:"rk4-k",size:n,usage:GPUBufferUsage.STORAGE}),f=e.createBuffer({label:"rk4-stage",size:n,usage:GPUBufferUsage.STORAGE}),t=e.createBuffer({label:"rk4-acc",size:n,usage:GPUBufferUsage.STORAGE}),l=GPUShaderStage.COMPUTE,h=e.createBindGroupLayout({entries:[{binding:0,visibility:l,buffer:{type:"uniform"}},{binding:1,visibility:l,buffer:{type:"read-only-storage"}},{binding:2,visibility:l,buffer:{type:"storage"}}]}),j=e.createBindGroupLayout({entries:[{binding:0,visibility:l,buffer:{type:"uniform"}},{binding:1,visibility:l,buffer:{type:"read-only-storage"}},{binding:2,visibility:l,buffer:{type:"read-only-storage"}},{binding:3,visibility:l,buffer:{type:"storage"}},{binding:4,visibility:l,buffer:{type:"storage"}}]}),A=e.createPipelineLayout({bindGroupLayouts:[h]}),q=e.createPipelineLayout({bindGroupLayouts:[j]}),M=e.createShaderModule({label:"rhs",code:en}),P=e.createShaderModule({label:"blend",code:nn}),E=e.createComputePipeline({label:"rhs",layout:A,compute:{module:M,entryPoint:"cs_main"}}),U=e.createComputePipeline({label:"rk4-s1",layout:q,compute:{module:P,entryPoint:"cs_stage1"}}),T=e.createComputePipeline({label:"rk4-s2",layout:q,compute:{module:P,entryPoint:"cs_stage2"}}),O=e.createComputePipeline({label:"rk4-s3",layout:q,compute:{module:P,entryPoint:"cs_stage3"}}),V=e.createComputePipeline({label:"rk4-fin",layout:q,compute:{module:P,entryPoint:"cs_finalize"}}),W=[e.createBindGroup({label:"rhs-0",layout:h,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:a[0]}},{binding:2,resource:{buffer:c}}]}),e.createBindGroup({label:"rhs-1",layout:h,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:a[1]}},{binding:2,resource:{buffer:c}}]})],F=e.createBindGroup({label:"rhs-stage",layout:h,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:f}},{binding:2,resource:{buffer:c}}]}),C=[e.createBindGroup({label:"blend-0",layout:j,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:a[0]}},{binding:2,resource:{buffer:c}},{binding:3,resource:{buffer:f}},{binding:4,resource:{buffer:t}}]}),e.createBindGroup({label:"blend-1",layout:j,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:a[1]}},{binding:2,resource:{buffer:c}},{binding:3,resource:{buffer:f}},{binding:4,resource:{buffer:t}}]})],G=[e.createBindGroup({label:"fin-0",layout:j,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:a[0]}},{binding:2,resource:{buffer:c}},{binding:3,resource:{buffer:a[1]}},{binding:4,resource:{buffer:t}}]}),e.createBindGroup({label:"fin-1",layout:j,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:a[1]}},{binding:2,resource:{buffer:c}},{binding:3,resource:{buffer:a[0]}},{binding:4,resource:{buffer:t}}]})];let B=0;const m=[u/me,o/me];function _(p){const y=B;let i=p.beginComputePass({label:"k1"});i.setPipeline(E),i.setBindGroup(0,W[y]),i.dispatchWorkgroups(m[0],m[1]),i.end(),i=p.beginComputePass({label:"s1"}),i.setPipeline(U),i.setBindGroup(0,C[y]),i.dispatchWorkgroups(g),i.end(),i=p.beginComputePass({label:"k2"}),i.setPipeline(E),i.setBindGroup(0,F),i.dispatchWorkgroups(m[0],m[1]),i.end(),i=p.beginComputePass({label:"s2"}),i.setPipeline(T),i.setBindGroup(0,C[y]),i.dispatchWorkgroups(g),i.end(),i=p.beginComputePass({label:"k3"}),i.setPipeline(E),i.setBindGroup(0,F),i.dispatchWorkgroups(m[0],m[1]),i.end(),i=p.beginComputePass({label:"s3"}),i.setPipeline(O),i.setBindGroup(0,C[y]),i.dispatchWorkgroups(g),i.end(),i=p.beginComputePass({label:"k4"}),i.setPipeline(E),i.setBindGroup(0,F),i.dispatchWorkgroups(m[0],m[1]),i.end(),i=p.beginComputePass({label:"rk4-fin"}),i.setPipeline(V),i.setBindGroup(0,G[y]),i.dispatchWorkgroups(g),i.end(),B=1-B}return{tick(p,y){for(let i=0;i<y;i++)_(p)},get readBuf(){return B},setCur(p){B=p},destroy(){c.destroy(),f.destroy(),t.destroy()}}}const S=256,I=256,_e=8,ve=.4,ye=80,an=16,xe={"lax-friedrichs":Je,rk4:rn};function on(e,a,s="lax-friedrichs"){const u=GPUShaderStage.COMPUTE,o=S*I,n=o*6*4,d=[0,1].map(r=>e.createBuffer({label:`state-${r}`,size:n,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST})),g=e.createBuffer({label:"params",size:ye,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),c=o*4,f=[0,1].map(r=>e.createBuffer({label:`tracer-${r}`,size:c,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST})),t=e.createBuffer({label:"tracer-params",size:an,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});let l=0,h=0,j=.25,A=.25,q=.02,M=.1,P=.01,E=.3,U=300,T=0,O=5,V=0,W=1,F=.002,C=1,G=1;const B=new ArrayBuffer(ye),m=new Uint32Array(B),_=new Float32Array(B);m[0]=S,m[1]=I,_[2]=1,_[3]=ve;const p=new Float32Array(4);function y(){p[0]=F,p[1]=C,p[2]=G,p[3]=0,e.queue.writeBuffer(t,0,p)}y();const i=e.createShaderModule({label:"render",code:Qe}),de=e.createRenderPipeline({label:"render",layout:"auto",vertex:{module:i,entryPoint:"vs"},fragment:{module:i,entryPoint:"fs",targets:[{format:a}]},primitive:{topology:"triangle-list"}}),Oe=de.getBindGroupLayout(0),Ve=[0,1].map(r=>[0,1].map(v=>e.createBindGroup({label:`render-s${r}-t${v}`,layout:Oe,entries:[{binding:0,resource:{buffer:g}},{binding:1,resource:{buffer:d[r]}},{binding:2,resource:{buffer:f[v]}}]}))),ce=e.createBindGroupLayout({entries:[{binding:0,visibility:u,buffer:{type:"uniform"}},{binding:1,visibility:u,buffer:{type:"read-only-storage"}},{binding:2,visibility:u,buffer:{type:"read-only-storage"}},{binding:3,visibility:u,buffer:{type:"storage"}},{binding:4,visibility:u,buffer:{type:"uniform"}}]}),We=e.createComputePipeline({label:"tracer",layout:e.createPipelineLayout({bindGroupLayouts:[ce]}),compute:{module:e.createShaderModule({label:"tracer",code:Xe}),entryPoint:"cs_main"}}),Ne=[0,1].map(r=>[0,1].map(v=>e.createBindGroup({label:`tracer-tc${r}-sc${v}`,layout:ce,entries:[{binding:0,resource:{buffer:g}},{binding:1,resource:{buffer:d[v]}},{binding:2,resource:{buffer:f[r]}},{binding:3,resource:{buffer:f[1-r]}},{binding:4,resource:{buffer:t}}]})));let N=0;function Re(r,v){const x=r.beginComputePass({label:"tracer"});x.setPipeline(We),x.setBindGroup(0,Ne[N][v]),x.dispatchWorkgroups(S/_e,I/_e),x.end(),N=1-N}function fe(){e.queue.writeBuffer(d[0],0,sn(S,I,M)),e.queue.writeBuffer(d[1],0,new Float32Array(o*6))}function pe(){e.queue.writeBuffer(f[0],0,new Float32Array(o)),e.queue.writeBuffer(f[1],0,new Float32Array(o)),N=0}fe(),pe();let w=xe[s](e,d,g,S,I);function De(r,v=1){m[4]=l,_[5]=h,_[6]=j,_[7]=P,_[8]=E,_[9]=U,_[10]=T,_[11]=O,m[12]=V,_[13]=A,_[14]=q,m[15]=W,_[16]=G,e.queue.writeBuffer(g,0,B);for(let x=0;x<v;x++)w.tick(r,1),Re(r,w.readBuf);l+=v}function $e(r,v){const x=r.beginRenderPass({colorAttachments:[{view:v,clearValue:{r:.03,g:.18,b:.42,a:1},loadOp:"clear",storeOp:"store"}]});x.setPipeline(de),x.setBindGroup(0,Ve[w.readBuf][N]),x.draw(6),x.end()}function Ye(){l=0,fe(),w.setCur(0),pe()}function Ke(r){const v=w.readBuf;w.destroy(),w=xe[r](e,d,g,S,I),w.setCur(v)}return{tick:De,render:$e,reset:Ye,setScheme:Ke,setF(r){h=r},setH(r){j=r},setH2(r){A=r},setGPrime(r){q=r},setSigma(r){M=r},setNu4(r){P=r},setAEq(r){E=r},setTau(r){U=r},setBeta(r){T=r},setGain(r){O=r},setMode(r){V=r},setLayerMode(r){W=r},setEEvap(r){F=r,y()},setKPrec(r){C=r,y()},setQSat(r){G=r,y()},get step(){return l},get simTime(){return l*ve},get f(){return h},get H(){return j},get H2(){return A},get g_prime(){return q},get sigma(){return M},get nu4(){return P},get A_eq(){return E},get tau(){return U},get beta(){return T},get gain(){return O},get mode(){return V},get layerMode(){return W},get e_evap(){return F},get k_prec(){return C},get q_sat(){return G}}}function sn(e,a,s){const u=new Float32Array(e*a*6),o=e/2,n=a/2,d=s*e,g=s*a;for(let c=0;c<a;c++)for(let f=0;f<e;f++){const t=(f-o)/d,l=(c-n)/g;u[c*e+f]=Math.exp(-(t*t+l*l))}return u}const K=document.getElementById("status"),he=document.getElementById("pause-btn"),un=document.getElementById("reset-btn"),be=document.getElementById("scheme-select"),se=document.getElementById("speed-slider"),ln=document.getElementById("speed-val"),X=document.getElementById("sigma-slider"),je=document.getElementById("sigma-val"),L=document.getElementById("H-slider"),dn=document.getElementById("H-val"),k=document.getElementById("H2-slider"),cn=document.getElementById("H2-val"),fn=document.getElementById("cbt-val"),pn=document.getElementById("c1-val"),Be=document.getElementById("c1-display"),H=document.getElementById("gp-slider"),gn=document.getElementById("gp-val"),mn=document.getElementById("c2-val"),R=document.getElementById("f-slider"),_n=document.getElementById("f-val"),vn=document.getElementById("lr-val"),Z=document.getElementById("nu4-slider"),qe=document.getElementById("nu4-val"),J=document.getElementById("Aeq-slider"),Pe=document.getElementById("Aeq-val"),ee=document.getElementById("tau-slider"),Ee=document.getElementById("tau-val"),ne=document.getElementById("beta-slider"),we=document.getElementById("beta-val"),b=document.getElementById("display-select"),te=document.getElementById("gain-slider"),Fe=document.getElementById("gain-val"),re=document.getElementById("evap-slider"),Ce=document.getElementById("evap-val"),ae=document.getElementById("qsat-slider"),Le=document.getElementById("qsat-val"),ie=document.getElementById("prec-slider"),ke=document.getElementById("prec-val"),ue=document.getElementById("layer1-btn"),le=document.getElementById("layer2-btn"),Ge=document.getElementById("h2-sep"),Se=document.getElementById("h2-label"),Ie=document.getElementById("gp-sep"),He=document.getElementById("gp-label"),ze=document.getElementById("h1-name"),Ae=document.getElementById("h1-hint"),Me=document.getElementById("h1-label-el");let Y=!1,oe=parseInt(se.value),z=!0;const yn=[{value:"0",text:"h anomaly (h − h_eq)"},{value:"1",text:"vorticity"},{value:"2",text:"raw h"},{value:"6",text:"tracer q (moisture)"}],xn=[{value:"0",text:"h₁ anomaly (h₁ − h_eq)"},{value:"1",text:"vorticity layer 1"},{value:"2",text:"raw h₁"},{value:"3",text:"h₂ interface"},{value:"4",text:"barotropic vorticity"},{value:"5",text:"baroclinic vorticity (ζ₁−ζ₂)"},{value:"6",text:"tracer q (moisture)"}];function Ue(e){const a=b.value;for(;b.options.length;)b.remove(0);for(const{value:s,text:u}of e)b.add(new Option(u,s));e.some(s=>s.value===a)&&(b.value=a)}function Q(e,a){dn.textContent=e.toFixed(2),z?(cn.textContent=a.toFixed(2),fn.textContent=Math.sqrt(e+a).toFixed(2)):pn.textContent=Math.sqrt(e).toFixed(2)}function D(e,a,s){if(!z)return;gn.textContent=e.toFixed(2);const u=a>0&&s>0?Math.sqrt(e*a*s/(a+s)):0;mn.textContent=u.toFixed(2)}function $(e,a,s){const u=Math.sqrt(z?a+s:a);_n.textContent=e.toFixed(3),vn.textContent=e>0?(u/e).toFixed(1):"∞"}function Te(e,a){z=e;const s=d=>{d.style.display="none"},u=d=>{d.style.display=""};if(e)u(Ge),u(Se),u(Ie),u(He),s(Be),ze.textContent="H₁",Ae.textContent="(upper depth)",Me.title="Mean depth of upper layer. Barotropic wave speed c=√(g·(H₁+H₂)).",Ue(xn),le.classList.add("layer-active"),ue.classList.remove("layer-active");else{s(Ge),s(Se),s(Ie),s(He),u(Be),ze.textContent="H",Ae.textContent="(depth)",Me.title="Mean layer depth. Wave speed c=√H.";const d=parseInt(b.value);Ue(yn),d>=3&&(b.value="0",a.setMode(0)),ue.classList.add("layer-active"),le.classList.remove("layer-active")}a.setLayerMode(e?1:0),a.reset();const o=parseFloat(L.value),n=parseFloat(k.value);Q(o,n),$(parseFloat(R.value),o,n),D(parseFloat(H.value),o,n)}async function hn(){var f;if(!navigator.gpu){K.textContent="WebGPU not supported — use Chrome 113+ or Safari 18+";return}const e=await navigator.gpu.requestAdapter();if(!e){K.textContent="No GPU adapter found";return}const a=await e.requestDevice(),u=document.getElementById("canvas").getContext("webgpu"),o=navigator.gpu.getPreferredCanvasFormat();u.configure({device:a,format:o,alphaMode:"opaque"});const n=on(a,o),d=e.info??await((f=e.requestAdapterInfo)==null?void 0:f.call(e))??{},g=d.description||d.vendor||"gpu";je.textContent=n.sigma.toFixed(2),X.value=n.sigma,L.value=n.H,k.value=n.H2,H.value=n.g_prime,Q(n.H,n.H2),D(n.g_prime,n.H,n.H2),$(n.f,n.H,n.H2),Z.value=n.nu4,qe.textContent=n.nu4.toFixed(3),J.value=n.A_eq,Pe.textContent=n.A_eq.toFixed(2),ee.value=n.tau,Ee.textContent=n.tau.toFixed(0),ne.value=n.beta,we.textContent=n.beta.toFixed(3),te.value=n.gain,Fe.textContent=n.gain.toFixed(0),b.value=n.mode.toString(),re.value=n.e_evap,Ce.textContent=n.e_evap.toFixed(3),ae.value=n.q_sat,Le.textContent=n.q_sat.toFixed(1),ie.value=n.k_prec,ke.textContent=n.k_prec.toFixed(1),he.addEventListener("click",()=>{Y=!Y,he.textContent=Y?"play":"pause"}),se.addEventListener("input",()=>{oe=parseInt(se.value),ln.textContent=oe}),X.addEventListener("input",()=>{const t=parseFloat(X.value);je.textContent=t.toFixed(2),n.setSigma(t),n.reset()}),L.addEventListener("input",()=>{const t=parseFloat(L.value),l=parseFloat(k.value);n.setH(t),Q(t,l),$(parseFloat(R.value),t,l),D(parseFloat(H.value),t,l)}),k.addEventListener("input",()=>{const t=parseFloat(k.value),l=parseFloat(L.value);n.setH2(t),Q(l,t),$(parseFloat(R.value),l,t),D(parseFloat(H.value),l,t)}),H.addEventListener("input",()=>{const t=parseFloat(H.value);n.setGPrime(t),D(t,parseFloat(L.value),parseFloat(k.value))}),R.addEventListener("input",()=>{const t=parseFloat(R.value);n.setF(t),$(t,parseFloat(L.value),parseFloat(k.value))}),Z.addEventListener("input",()=>{const t=parseFloat(Z.value);n.setNu4(t),qe.textContent=t.toFixed(3)}),J.addEventListener("input",()=>{const t=parseFloat(J.value);n.setAEq(t),Pe.textContent=t.toFixed(2)}),ee.addEventListener("input",()=>{const t=parseFloat(ee.value);n.setTau(t),Ee.textContent=t.toFixed(0)}),ne.addEventListener("input",()=>{const t=parseFloat(ne.value);n.setBeta(t),we.textContent=t.toFixed(3)}),te.addEventListener("input",()=>{const t=parseFloat(te.value);n.setGain(t),Fe.textContent=t.toFixed(0)}),b.addEventListener("change",()=>{n.setMode(parseInt(b.value))}),un.addEventListener("click",()=>n.reset()),be.addEventListener("change",()=>{n.setScheme(be.value)}),re.addEventListener("input",()=>{const t=parseFloat(re.value);n.setEEvap(t),Ce.textContent=t.toFixed(3)}),ae.addEventListener("input",()=>{const t=parseFloat(ae.value);n.setQSat(t),Le.textContent=t.toFixed(1)}),ie.addEventListener("input",()=>{const t=parseFloat(ie.value);n.setKPrec(t),ke.textContent=t.toFixed(1)}),ue.addEventListener("click",()=>{z&&Te(!1,n)}),le.addEventListener("click",()=>{z||Te(!0,n)});function c(){if(!Y){const t=a.createCommandEncoder({label:"frame"});n.tick(t,oe),n.render(t,u.getCurrentTexture().createView()),a.queue.submit([t.finish()])}K.textContent=`${g} | 256×256 | t = ${n.simTime.toFixed(1)}`,requestAnimationFrame(c)}requestAnimationFrame(c)}hn().catch(e=>{console.error(e),K.textContent=`Error: ${e.message}`});
